# Fit model using standard hugging face script
...
def main():
    ...
    train_dataset, test_dataset = data_generator.get_train_test(tokenizer, args, target='Yoni Friedman', data_dir='data/inbox')
